 ...
 * @version: $Id: wp_phpbb_bridge_portal.php, v0.0.9 2011/10/27 11:10:27 leviatan21 Exp $
...
if (isset($config['wp_phpbb_bridge_portal_disable']) && $config['wp_phpbb_bridge_portal_disable'])
{
	if (isset($config['wp_phpbb_bridge_wordpress_path']))
	{
		...
		if (file_exists($wordpress_root_path . 'wp-phpbb-bridge-portal.php'))
		{
			include($wordpress_root_path . 'wp-phpbb-bridge-portal.php');
		}
	}
}
